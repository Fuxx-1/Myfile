<template>
    <el-form :model="form" label-width="130px" style="padding: 70px;">
        ...
        <el-form-item label="库存">
            <el-input v-model="form.margin" disabled />
        </el-form-item>
        <el-form-item label="详情">
            <el-input v-model="form.detail" type="textarea" disabled />
        </el-form-item>
...
let form = reactive({
    ...
    "detail": "",
    "margin": null,
    "bookInfCreateTime": null,
    "bookInfUpdateTime": null,
    "bookDetailCreateTime": null,
    "bookDetailUpdateTime": null,
})
