...
public class ConnectJWGL {
    ...
    private Connection.Response responseTemp;
    ...
    private void getCsrftoken(){
        try{
            ...
            connection.header("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 Edg/93.0.961.44");
    ...
    public boolean beginLogin() throws Exception{
        ...
        connection.data("mm",password);
        responseTemp = connection.cookies(cookies).ignoreContentType(true)
                .method(Connection.Method.POST).execute();
        cookies.put("JSESSIONID", responseTemp.cookie("JSESSIONID"));
        response = connection.execute();
        document = Jsoup.parse(response.body());
