 ...
 *
 * @date:2019/9/27 18:51
 */


public class RSA {
    public String RSAEncrypt(String password, String modulus, String exponent){
        BigInteger n = new BigInteger(modulus, 16);
        BigInteger e = new BigInteger(exponent, 16);

        BigInteger r = RSADoPublic(pkcs1pad2(password, (n.bitLength() + 7) >> 3), n, e);
    ...
    private BigInteger RSADoPublic(BigInteger x, BigInteger n, BigInteger e){
        return x.modPow(e, n);
    }
