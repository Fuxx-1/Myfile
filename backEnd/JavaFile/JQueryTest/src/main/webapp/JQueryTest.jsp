...
<div class="main">
    ...
    <table>
        <tr>
            <td colspan="3">
                <button id="lessBtn">填写简要信息</button>
                <button id="moreBtn">填写详细信息</button>
            </td>
        </tr>
        <tr>
            <td>姓&emsp;&emsp;名：</td>
            <td><input type="text" id="name"/></td>
            <td id="nameStatus" class="status"></td>
        </tr>
        <tr>
            <td>密&emsp;&emsp;码：</td>
            <td><input type="password" id="pwd"/></td>
            <td id="pwdStatus" class="status"></td>
        </tr>
        <tr>
            <td>密码确认：</td>
            <td><input type="password" id="pwd2"/></td>
            <td id="pwd2Status" class="status"></td>
        </tr>
        <tr>
            <td>性&emsp;&emsp;别：</td>
            <td>
        ...
        <tr class="moreInf">
            ...
            <td id="emailStatus" class="status"></td>
        </tr>
        <tr class="moreInf">
            <td>宿&emsp;&emsp;舍：</td>
            <td id="room">
        ...
        <tr>
            <td colspan="3">
                <input type="checkbox" id="agree"/>同意本系统使用协议&emsp;
                <a href="javascript:void(0)" onclick="">查看使用协议</a>
            </td>
        </tr>
        <tr>
            <td colspan="3">
