...
public class FfmpegCmd {
    ...
    public void destroy() {
        if (inputStream != null) {
            try {
                ...
                System.out.println("Error closing input stream" + t);
            }
            inputStream = null;
        }
        ...
        if (outputStream != null) {
            try {
                ...
                System.out.println("Error closing output stream" + t);
            }
            outputStream = null;
        }
        ...
        if (errorStream != null) {
            try {
                ...
                System.out.println("Error closing error stream" + t);
            }
            errorStream = null;
        }
    ...
    public int getProcessExitCode() {
        ...
        try {
            ...
            System.out.println("Interrupted during waiting on process, forced shutdown?" + ex);
        }
